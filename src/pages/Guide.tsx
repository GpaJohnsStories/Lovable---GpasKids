        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-100 rounded-lg p-3 mb-6 shadow-sm">
            <div className="flex flex-wrap justify-center gap-1.5">
              ...
              >
                <span className="text-orange-800 text-[10px]">Your Guide to</span>
                <span className="text-orange-800 text-[10px]">the Home Page</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-orange-800 text-[10px]">Story Library</span>
              </button>
              <button 
