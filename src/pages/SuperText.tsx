                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      handleInputChange('copyright_status', value);
                        ...
                        <SelectTrigger className={`w-full text-white ${formData.copyright_status === '©' || !formData.copyright_status ? 'bg-red-600 border-red-700' : formData.copyright_status === 'L' ? 'bg-orange-500 border-orange-600' : formData.copyright_status === 'CC' ? 'bg-green-600 border-green-700' : formData.copyright_status === 'P' ? 'bg-blue-600 border-blue-700' : 'bg-red-600 border-red-700'}`} style={{
                        fontSize: '21px',
                        fontFamily: 'Arial',
                        fontWeight: 'bold'
                      }}>
