                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <textarea placeholder="Paste Google Drive Share Code" rows={3} className="w-full border-2 border-purple-400 focus:border-purple-500 rounded-md px-3 py-2 text-sm resize-none" style={{whiteSpace: 'pre-wrap', wordWrap: 'break-word'}} />
                ...
                <div ref={audioSectionRef} className="w-full bg-white/90 backdrop-blur-sm rounded-lg border-2 border-blue-400 p-6 relative">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label className="font-semibold mb-2 block">Or Upload from Google Drive</Label>
                      <div className="space-y-2">
                        <textarea placeholder="Paste Google Drive Share Code" rows={3} className="w-full border-2 border-blue-400 focus:border-blue-500 rounded-md px-3 py-2 text-sm resize-none" style={{whiteSpace: 'pre-wrap', wordWrap: 'break-word'}} />
                        <button type="button" className="w-full px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 text-sm font-medium">
                          🔄 Fetch & Upload
                        </button>
                      </div>
