        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-black leading-relaxed mb-4" style={{ fontFamily: 'Georgia, serif' }}>
                ...
                <p className="text-lg text-black leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="text-lg text-black leading-relaxed space-y-2 list-disc list-inside ml-4" style={{ fontFamily: 'Georgia, serif' }}>
            ...
            <div className="text-center pt-8">
              <p className="text-lg text-black leading-relaxed italic mb-6" style={{ fontFamily: 'Georgia, serif' }}>
