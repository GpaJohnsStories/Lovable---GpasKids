    ...
    <TooltipProvider>
      <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-amber-100">
        ...
        <main className="container mx-auto px-4 pt-8 pb-12">
          {/* About Grandpa John - SuperBox */}
          <div className="mb-8">
            <SuperBox code="SYS-AGJ" />
          </div>

          {/* About Buddy - SuperBox */}
          <div id="buddy" className="mb-8">
            <SuperBox code="SYS-BDY" />
          </div>
          ...
          <div id="special-thank-you" className="max-w-6xl mx-auto border-4 border-yellow-500 rounded-lg p-6 mt-8 bg-purple-100 relative">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              ...
              <div className="flex flex-col gap-2.5 w-full md:w-3/5 lg:w-2/3">
