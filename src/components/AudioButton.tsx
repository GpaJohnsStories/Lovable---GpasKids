  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <div className="absolute top-full right-0 mt-3 px-4 py-2 bg-red-600 text-white text-base font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap z-20 shadow-lg border border-red-700">
