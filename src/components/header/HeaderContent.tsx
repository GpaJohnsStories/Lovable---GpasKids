      ...
      <div className="grid grid-cols-3 gap-4 h-full items-end">
        ...
        <div className="flex items-start gap-4 justify-start">
          <button 
            ...
            className="group relative z-10 bg-gradient-to-br from-green-600/80 to-green-700/60 hover:from-red-600/80 hover:to-red-700/60 backdrop-blur-sm rounded-lg p-2 flex flex-col items-center text-center w-28 sm:w-32 h-32 sm:h-36 shadow-[0_8px_16px_rgba(0,0,0,0.3),0_4px_8px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.3)] border-2 border-green-600 hover:border-red-600 transform hover:scale-105 transition-all duration-200 cursor-pointer active:scale-95"
          >
            <img 
        ...
        <div className="flex justify-center items-end">
          <NavigationMenu>
            <NavigationMenuList className="flex flex-row gap-1 lg:gap-2 items-end">
              <NavigationMenuItem>
                <NavigationButton 
                  item={{
                    name: "Home",
