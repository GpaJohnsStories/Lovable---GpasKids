            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button 
                  ...
                  className="group relative z-10 bg-gradient-to-br from-orange-500/80 to-orange-600/60 hover:from-orange-400/80 hover:to-orange-500/60 backdrop-blur-sm rounded-full p-2 flex flex-col items-center text-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 min-w-12 sm:min-w-14 md:min-w-16 flex-shrink-0 shadow-[0_8px_16px_rgba(0,0,0,0.3),0_4px_8px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.3)] border-2 border-orange-500 hover:border-orange-400 transform hover:scale-105 hover:-translate-y-1 transition-all duration-200 cursor-pointer active:scale-95 active:translate-y-1"
                >
                  {hgjLoading && (
