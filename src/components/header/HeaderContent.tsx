...
const HeaderContent = ({ isHomePage }: HeaderContentProps) => {
  ...
  return (
    <div className={isHomePage ? "space-y-4" : "flex items-center justify-between relative"}>
      {/* Top row with Buddy, Title, and Dancing GIF */}
      ...
      {/* Navigation Menu - Show on home page, centered horizontally */}
      {isHomePage && (
