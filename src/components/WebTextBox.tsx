  ...
  if (isSysWel) {
    return (
      <>
        ...
        <div className="absolute top-4 right-4 z-[5] flex flex-col items-center">
          <div className="text-base sm:text-lg font-handwritten font-bold text-green-800 mb-0 leading-none -mb-1">
            Click to listen
          </div>
