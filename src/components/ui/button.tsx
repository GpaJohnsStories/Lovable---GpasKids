  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-[0_6px_12px_rgba(0,0,0,0.15),0_3px_6px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,0.2)] border hover:shadow-[0_8px_16px_rgba(0,0,0,0.2),0_4px_8px_rgba(0,0,0,0.15),inset_0_2px_4px_rgba(255,255,255,0.25)] hover:scale-[1.02] active:scale-[0.98] active:shadow-[0_2px_4px_rgba(0,0,0,0.2),inset_0_2px_4px_rgba(0,0,0,0.1)]",
  {
    variants: {
      variant: {
        ...
        successPill: "bg-[#228B22] hover:bg-[#1E7B1E] text-white text-[21px] font-bold font-fun rounded-full px-6 py-3 min-h-[70px] h-[70px] shadow-[0_6px_0_#0F5A0F,0_8px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_4px_0_#0F5A0F,0_6px_6px_rgba(0,0,0,0.3)] active:shadow-[0_2px_0_#0F5A0F,0_3px_3px_rgba(0,0,0,0.3)] active:translate-y-[2px] transform transition-all duration-150 ease-in-out border-0",
        orangePill: "bg-gradient-to-b from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white text-[21px] font-bold font-fun rounded-full px-6 py-3 min-h-[70px] h-[70px] shadow-[0_6px_0_#ea580c,0_8px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_4px_0_#ea580c,0_6px_6px_rgba(0,0,0,0.3)] active:shadow-[0_2px_0_#ea580c,0_3px_3px_rgba(0,0,0,0.3)] active:translate-y-[2px] transform transition-all duration-150 ease-in-out border-0",
      },
      size: {
