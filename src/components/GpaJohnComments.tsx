      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center">
          <Link to="/viewcomments" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <button className="bg-gradient-to-b from-blue-400 to-blue-600 text-white border-blue-700 h3-fun-24 px-8 py-4 h-auto min-h-11 rounded-full shadow-[0_6px_12px_rgba(37,99,235,0.3),0_3px_6px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,0.3)] border hover:shadow-[0_8px_16px_rgba(37,99,235,0.4),0_4px_8px_rgba(0,0,0,0.15),inset_0_2px_4px_rgba(255,255,255,0.4)] hover:scale-[1.02] active:scale-[0.98] active:shadow-[0_2px_4px_rgba(0,0,0,0.2),inset_0_2px_4px_rgba(0,0,0,0.1)] transition-all duration-200 flex items-center justify-center whitespace-normal text-center">
