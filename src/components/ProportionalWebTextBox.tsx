            ...
            {mainPhoto && (
              <div className="w-fit flex-shrink-0">
                <div className="inline-block">
                  ...
                  <div className="mt-2 bg-emerald-900/90 backdrop-blur-sm rounded-lg px-3 py-2 text-sm text-yellow-300 text-center font-bold shadow-lg border border-emerald-700" style={{ fontSize: '13pt', fontFamily: 'Comic Sans MS, cursive, sans-serif' }}>
