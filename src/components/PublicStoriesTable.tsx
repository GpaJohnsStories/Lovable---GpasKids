                  ...
                  <TableRow className="bg-background hover:bg-background">
                    <TableHead className="p-1 text-center bg-background border-r border-gray-200 w-20">
                      <Tooltip>
                        ...
                        <TooltipContent 
                          className="bg-amber-50 border border-amber-200 text-amber-900 text-sm p-3 max-w-xs"
                          style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
                        >
                          <p>Each story has a unique code. Write this down so you can find your favorite stories easily later!</p>
                        </TooltipContent>
                      </Tooltip>
                    </TableHead>
                    <TableHead className="p-1 text-center bg-background border-r border-gray-200">
                      <Tooltip>
                        ...
                        <TooltipContent 
                          ...
                          style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
                        >
                          <p>Click on any story title to read the story. Hover over titles and they will turn red!</p>
                        </TooltipContent>
                      </Tooltip>
                    </TableHead>
                    <TableHead className="p-1 text-center bg-background border-r border-gray-200 w-24">
                      <Tooltip>
                        ...
                        <TooltipContent 
                          ...
                          style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
                        >
                          <p>The person who wrote the story. Click the "Bio" button to learn more about the author!</p>
                        </TooltipContent>
                      </Tooltip>
                    </TableHead>
                    <TableHead className="p-1 text-center bg-background border-r border-gray-200 w-28">
                      <Tooltip>
                        ...
                        <TooltipContent 
                          ...
                          style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
                        >
                          <p>Stories are grouped by type: Fun Stuff, Life Lessons, North Pole adventures, and World Changers. Click to filter by category!</p>
                        </TooltipContent>
                      </Tooltip>
                    </TableHead>
                    <TableHead className="p-1 text-center bg-background border-r border-gray-200 w-20">
                      <Tooltip>
                        ...
                        <TooltipContent 
                          ...
                          style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
                        >
                          <p>How many times this story has been read by visitors. Popular stories have higher numbers!</p>
                        </TooltipContent>
                      </Tooltip>
                    </TableHead>
                    <TableHead className="p-1 text-center bg-background w-24">
                      <Tooltip>
                        ...
                        <TooltipContent 
                          ...
                          style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
                        >
                          <p>When this story was last updated. Click any column heading to sort - first click sorts down, second click sorts up!</p>
                        </TooltipContent>
                      </Tooltip>
                    </TableHead>
                  </TableRow>
