          ...
          <div className="mb-6">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <div className="relative w-full max-w-lg">
                ...
                <Input type="text" placeholder="Just type to search any word, title or author" value={localSearchTerm} onChange={e => setLocalSearchTerm(e.target.value)} className="pl-10 pr-10 py-3 text-sm sm:text-base border-2 border-brand-brown focus:border-brand-brown rounded-lg placeholder:font-bold w-full min-w-0" />
