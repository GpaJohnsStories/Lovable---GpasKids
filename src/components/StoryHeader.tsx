    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="text-center mb-4">
          {titleHtml ? (
            <h1 
              className="text-3xl font-bold text-amber-800 leading-tight text-center font-fun"
              dangerouslySetInnerHTML={createSafeHeaderHtml(titleHtml)}
            />
          ) : (
            <h1 className="text-3xl font-bold text-amber-800 leading-tight text-center font-fun">
              {title}
            </h1>
          )}
        </div>
