  ...
  const colorGroups = [
    ...
    },
    {
      ...
      colors: [
        ...
        { name: 'Rust Orange', hex: '#9c441a', description: 'Used to outline data entry fields, 2px. Best Used for: Autumn adventures, warm earth elements, vintage details, and traditional themes. Creates nostalgic warmth. Ideal for harvest stories and seasonal tale backgrounds.' },
