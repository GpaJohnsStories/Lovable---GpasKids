...
const COLOR_PRESETS = {
  primary: [
    ...
    { 
      ...
      description: 'Trustworthy & calm - great for educational content. <br>Ideal for: How-To guides, About page, main navigation'
    },
    { 
      name: 'Gold', 
      hex: '#EAB308',
      ...
      description: 'Warm treasure feel - creates Grandpa\'s cozy atmosphere. <br>Ideal for: Featured stories, special announcements'
    },
    { 
      name: 'Sunset Orange', 
      hex: '#F97316',
      ...
      description: 'Storytelling warmth - evokes fireside tale moments. <br>Ideal for: Story submission, writing tools, creative sections'
    },
  ],
  secondary: [
    ...
    { 
      ...
      description: 'Gentle excitement - not harsh, perfect for highlights. <br>Ideal for: Important alerts, featured content, call-to-action'
    },
    { 
      name: 'Royal Purple', 
      hex: '#8B5CF6',
      ...
      description: 'Magical wonder - sparks imagination in young minds. <br>Ideal for: Fantasy stories, creative writing, imagination sections'
    },
    { 
      name: 'Slate Gray', 
      hex: '#64748B',
      ...
      description: 'Calm neutrality - accessible with good contrast. <br>Ideal for: Settings, admin tools, secondary navigation'
    },
  ],
  additional: [
    ...
    { 
      ...
      description: 'Welcoming comfort - matches living room atmosphere. <br>Ideal for: Home page, welcome sections, cozy story categories'
    },
    { 
      name: 'Bright Yellow', 
      hex: '#FACC15',
      ...
      description: 'Cheerful & energetic - draws children\'s attention safely. <br>Ideal for: Games, interactive features, fun activities'
    },
    { 
      name: 'Meadow Green', 
      hex: '#65A30D',
      ...
      description: 'Fresh growth - encourages learning and discovery. <br>Ideal for: Educational content, new features, learning tools'
    },
    { 
      name: 'Cream', 
      hex: '#FEF3C7',
      ...
      description: 'Soft comfort - gentle on young eyes with high contrast. <br>Ideal for: Quiet reading sections, calm content areas'
    },
    { 
      name: 'Peach', 
      hex: '#FDBA74',
      ...
      description: 'Gentle warmth - creates welcoming child-friendly feel. <br>Ideal for: Comments section, community features, safe spaces'
    },
  ]
};
