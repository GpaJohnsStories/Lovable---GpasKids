...
const WEBTEXT_USAGE = [
  ...
  { code: 'SYS-CCR', path: '/help-gpa', fallbackTitle: 'Comments Rules' },
  { code: 'SYS-CCW', path: '/help-gpa', fallbackTitle: 'Comments Welcome' },
  ...
  { code: 'SYS-GJC', path: '/help-gpa', fallbackTitle: 'Grandpa John Comments' },
