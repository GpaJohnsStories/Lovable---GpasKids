-- First, update all existing values to valid ones
UPDATE public.stories 
SET copyright_status = '©' 
WHERE copyright_status IS NULL OR copyright_status = 'P' OR copyright_status NOT IN ('©', 'O', 'S');

-- Drop the old constraint
ALTER TABLE public.stories 
DROP CONSTRAINT IF EXISTS stories_copyright_status_check;

-- Add the new constraint with copyright symbol
ALTER TABLE public.stories 
