-- Insert the SYS-CC1 story for comments page welcome section (fixed apostrophes)
    ...
    <div class="space-y-4 text-left">
      <div>
        ...
        <ul class="list-disc list-inside mt-1 space-y-1 pl-4">
          ...
          <li>Be nice to everyone, even if you do not agree with them.</li>
      ...
      <div>
        ...
        <ul class="list-disc list-inside mt-1 space-y-1 pl-4">
          ...
          <li>Do not talk about other things.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="list-disc list-inside mt-1 space-y-1 pl-4">
          <li>Never share your full name, address, phone number, or email. That is your secret!</li>
          <li>Do not ask others for their secret information either.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="list-disc list-inside mt-1 space-y-1 pl-4">
          <li>This space is just for Grandpa John Stories. No trying to sell things or posting links to other websites.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="list-disc list-inside mt-1 space-y-1 pl-4">
          <li>If you see a comment that is not kind or breaks a rule, tell a grown-up right away! You or a grown-up can send a comment explaining your concern.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="list-disc list-inside mt-1 space-y-1 pl-4">
          ...
          <li>If a comment does not follow the rules, it might not be posted.</li>
        </ul>
      </div>
    </div>
  </div>',
