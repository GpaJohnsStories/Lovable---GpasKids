...
INSERT INTO stories (story_code, title, content, category, publication_status, created_by, updated_by) VALUES
...
'WebText', 'Published', 'system', 'system'),
...
<pre><code>INSERT INTO stories (story_code, title, content, category, publication_status, created_by, updated_by) VALUES
(''YOUR-CODE'', ''Your Title'', ''&lt;p&gt;Your content here&lt;/p&gt;'', ''WebText'', ''Published'', ''system'', ''system'');</code></pre>
...
<ol>
<li>Immediately unpublish the content (set publication_status = ''Draft'')</li>
