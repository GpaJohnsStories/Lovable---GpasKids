...
<ul>
  <li><code>code</code> (required) - Story code like "SYS-WE2" (also used as HTML anchor id)</li>
...
<ul>
  <li>ID is the story code itself (e.g., code="SYS-WE2" creates id="SYS-WE2")</li>
  <li>Placed at top of box (before title)</li>
  <li>Allows linking directly to box via #SYS-WE2</li>
...
<ul>
  ...
  <li>Create anchor at top of box using story code as id</li>
</ul>
...
<ul>
  ...
  <li>Update AdminManual.tsx (remove id prop, just pass code and title)</li>
</ul>

<p><strong>Phase 4: Testing & Validation (1 credit)</strong></p>
<ul>
  <li>Test all webtext boxes display correctly</li>
  <li>Verify anchor links work (#SYS-WE2, etc.)</li>
  <li>Confirm HTML overrides work properly</li>
  <li>Test category validation rejects story/author-bio categories</li>
</ul>

<p><strong>Phase 5: Cleanup (1 credit)</strong></p>
<ul>
  <li>Delete BaseWebTextBox.tsx and related utilities</li>
  <li>Delete SysWe2WebTextBox.tsx</li>
  <li>Delete SysWelWebTextBox.tsx</li>
  <li>Delete WebTextBox.tsx wrapper</li>
...
<ul>
  ...
  <li>src/utils/superBoxTheme.ts - Theme utilities for color presets</li>
</ul>
...
<ul>
  ...
  <li>src/utils/webtextTheme.ts (if no longer needed)</li>
</ul>

<h2>Files to Modify</h2>
<ul>
  <li>src/pages/AdminManual.tsx - Update all webtext boxes to use SuperBox</li>
  <li>Any other pages using webtext boxes</li>
</ul>

<h2>Example Usage After Refactor</h2>
<pre><code>&lt;SuperBox 
  code="ADM-MAB"
  title="WebText Box System Overview"
/&gt;</code></pre>

<p><strong>Note:</strong> The id anchor will automatically be "ADM-MAB" for direct linking (#ADM-MAB)</p>'
